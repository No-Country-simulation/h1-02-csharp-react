...
const ProfileResume = ({ bgColor, patients }) => {
  ...
  return (
    <div className={`backdrop-blur ${bgColor ? bgColor : 'bg-[rgba(253,239,244,0.1)]'} rounded-3xl py-6 px-4 w-full mb-4 shadow-custom text-neutrals600 flex flex-col gap-2`}>
      <div>
      ...
      <TextAreaInput name='Diagnóstico *' placeholder='Completar diagnóstico' id='patology' value={selectedPatient.diagnosis} height='h-[100px]'/>
