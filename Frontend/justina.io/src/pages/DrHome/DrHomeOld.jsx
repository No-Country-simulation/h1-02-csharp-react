...
export const DrHomeOld = () => {
  ...
  return (
    <div className="mt-4 p-4 ">
      <p className="text-primary text-titulopag text-start font-semibold">
        Pacientes
      </p>
          ...
          <tbody className="bg-[rgba(253,239,244,0.4)] shadow-custom">
            {datostabla.map((data) => (
              <tr key={data.id} className="border-b dark:border-neutral-500">
                ...
                <td>{data.contacto}</td>
                <td>
                  <Link to="/patientdetails">Ver Paciente</Link>
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <nav aria-label="Page navigation example">
        <ul className="list-style-none flex justify-center mt-4">
          ...
          <li aria-current="page">
            <a
              className="relative block rounded-[48px] bg-[rgba(253,239,244,0.4)] shadow-custom px-3 py-1.5 text-sm text-neutral-600 transition-all duration-300 hover:bg-neutral-100  text-primary dark:hover:bg-neutral-700 dark:hover:text-white"
              href="#!"
            >
              1
            </a>
          ...
          <li>
            <a
              className="relative block rounded-[48px] bg-[rgba(253,239,244,0.4)] shadow-custom px-3 py-1.5 text-sm font-medium text-primary-700 transition-all duration-300"
              href="#!"
            >
              2
            </a>
