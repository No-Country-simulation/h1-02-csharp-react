  ...
  return (
    <section className="p-4 flex justify-center">
      <div className="backdrop-blur bg-[rgba(253,239,244,0.1)] rounded-3xl py-4 px-6 w-11/12 shadow-custom flex flex-col gap-4">
        ...
        />
        <img
          src={medicalCenter.image}
          alt={medicalCenter.name}
          className="w-[181px] h-[154px] rounded-2xl self-center"
        />
        <FormInput
          name="CUIT *"
          type="text"
          placeholder="CUIT no encontrado"
          id="cuit"
          value={medicalCenter.cuit}
          readOnly={"true"}
        />
        <FormInput
          name="Email *"
          ...
          id="email"
          value={medicalCenter.email}
          readOnly={"true"}
        />
        <FormInput
          name="Teléfono *"
          type="text"
          placeholder="Teléfono no encontrado"
          id="phone"
